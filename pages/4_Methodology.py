...
st.image("Flowchart for chatbot.png", caption="Flowchart for Chatbot Use Case")
...
st.image("Flowchart for dashboard.png", caption="Flowchart for Resale Price Dashboard Use Case")
